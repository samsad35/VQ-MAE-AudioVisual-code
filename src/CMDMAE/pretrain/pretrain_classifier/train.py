...
from ...model import CMDMAE, Classifier, SpeechVQVAE, Query2Label
...
class Classifier_Train(Train):
    def __init__(self, cmdmae: CMDMAE,
    ...
    def one_epoch(self):
        ...
        losses = []
        acces = []
        for audio, visual, label in tqdm(iter(self.training_loader)):
    ...
    def eval(self):
        ...
        with torch.no_grad():
            for audio, visual, label in tqdm(iter(self.validation_loader)):
